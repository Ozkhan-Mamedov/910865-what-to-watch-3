...
const withFilmAddedToWatchStatus = (Component) => {
  class WithFilmAddedToWatchStatus extends React.PureComponent {
    constructor(props) {
      ...
      this.handleAddToWatchButtonClick = this.handleAddToWatchButtonClick.bind(this);
    }

    handleAddToWatchButtonClick() {
    ...
    render() {
      ...
      return <Component {...this.props}
        ...
        onAddToWatchButtonClick={this.handleAddToWatchButtonClick}
      />;
    }
  }
  ...
  const mapDispatchToProps = (dispatch) => ({
    changeFavoriteFilmStatus(id, status, resolver) {
      dispatch(DataOperation.changeFavoriteFilmStatus(id, status, resolver));
    },
    updateData() {
      dispatch(DataOperation.getFilmList());
      dispatch(DataOperation.getPromoMovieData());
