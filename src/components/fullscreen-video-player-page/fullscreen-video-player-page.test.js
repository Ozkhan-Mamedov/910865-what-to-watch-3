...
import FullscreenVideoPlayerPage from "./fullscreen-video-player-page";
...
it(`FullscreenVideoPlayerPage renders correctly`, () => {
  const tree = renderer
    .create(
        <FullscreenVideoPlayerPage film={film} onExitButtonClick={() => {}} formatRemainingTime={() => {}}/>, {
          createNodeMock: () => {
            return {};
          }
        }
